...
struct NetworkHelper {
    ...
    static func createUrlSession(sessionName sessionDescription: String) -> URLSession {
    ...
    static func createRequest(for url: URL, withMethod httpMethod: HttpMethods) -> URLRequest {
